 ...
 */
package net.hackedclient.update;
...
public final class HackedClientUpdater implements UpdateListener
{
	...
	public void onUpdate()
	{
		...
		HackedClient.INSTANCE.getEventManager().remove(UpdateListener.class,
			this);
	}
