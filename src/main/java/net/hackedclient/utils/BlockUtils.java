...
public enum BlockUtils {
    ...
    private static final MinecraftClient MC = HackedClient.MC;
    ...
    /**
     * @param name a String containing the block's name ({@link Identifier})
    ...
    /**
     * @param nameOrId a String containing the block's name ({@link Identifier}) or
     *                 numeric ID.
